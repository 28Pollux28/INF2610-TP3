...
// La solution ici est d'ordonner nos ressources (les mutex) pour éviter l'attente circulaire. C'est la solution classique du problème des philosophes. (lignes 19-25)